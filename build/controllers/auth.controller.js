...
exports.register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, nombre, email, password, rol, userExists, hashedPassword, usuario, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _req$body = req.body, nombre = _req$body.nombre, email = _req$body.email, password = _req$body.password, rol = _req$body.rol;
          _context.p = 1;
          _context.n = 2;
          return _db["default"].usuario.findUnique({
            where: {
              email: email
            }
          });
        case 2:
          ...
          return _context.a(2, res.status(400).json({
            message: "El usuario que desea registrar ya existe"
          }));
        case 3:
          _context.n = 4;
        ...
        case 4:
          ...
          _context.n = 5;
          return _db["default"].usuario.create({
            data: {
              nombre: nombre,
              email: email,
...
exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _req$body2, email, password, user, isPasswordValid, token, _t2;
