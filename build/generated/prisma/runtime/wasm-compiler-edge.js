...
var oe = (e, t) => () => (t || e((t = {
  ...
  ut = (e, t) => {
    for (var r in t) Wr(e, r, {
      get: t[r],
      enumerable: !0
    });
  },
  Lo = (e, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function") for (let i of cu(t)) !pu.call(e, i) && i !== r && Wr(e, i, {
      get: () => t[i],
      enumerable: !(n = lu(t, i)) || n.enumerable
    });
    return e;
  };
var Ae = (e, t, r) => (r = e != null ? au(uu(e)) : {}, Lo(t || !e || !e.__esModule ? Wr(r, "default", {
    value: e,
    enumerable: !0
  }) : r, e)),
  No = e => Lo(Wr({}, "__esModule", {
    value: !0
  }), e);
function si(e, t) {
...
function mu(e) {
  let r = Object.getOwnPropertyNames(DataView.prototype).filter(a => a.startsWith("get") || a.startsWith("set")),
    ...
    i = (a, f) => function (w = 0) {
      return Y(w, "offset"), pe(w, "offset"), X(w, "offset", this.length - 1), new DataView(this.buffer)[r[a]](w, f);
    },
    o = (a, f) => function (w, v = 0) {
      let A = r[a].match(/set(\w+\d+)/)[1].toLowerCase(),
        R = fu[A];
      return Y(v, "offset"), pe(v, "offset"), X(v, "offset", this.length - 1), du(w, "value", R[0], R[1]), new DataView(this.buffer)[r[a]](v, w, f), v + parseInt(r[a].match(/\d+/)[0]) / 8;
    },
    s = a => {
      a.forEach(f => {
  ...
  c = fe(() => {
    ...
    h = class e extends Uint8Array {
      ...
      write(t, r, n, i = "utf8") {
        ...
        return i = typeof r == "string" ? r : typeof n == "string" ? n : i, Y(o, "offset"), Y(s, "length"), X(o, "offset", this.length), X(s, "length", this.length), (i === "ucs2" || i === "ucs-2" || i === "utf16le" || i === "utf-16le") && (s = s - s % 2), si(t, i).copy(this, o, 0, s);
      }
      fill(t = 0, r = 0, n = this.length, i = "utf-8") {
        let o = typeof r == "string" ? 0 : r,
          s = typeof n == "string" ? this.length : n;
        if (i = typeof r == "string" ? r : typeof n == "string" ? n : i, t = e.from(typeof t == "number" ? [t] : t ?? [], i), Uo(i, "encoding"), X(o, "offset", this.length), X(s, "end", this.length), t.length !== 0) for (let a = o; a < s; a += t.length) super.set(t.slice(0, t.length + a >= this.length ? this.length - a : t.length), a);
        return this;
      }
      ...
      toString(t = "utf8", r = 0, n = this.length) {
        ...
        if (t === "binary" || t === "ascii" || t === "latin1" || t === "latin-1") return this.slice(r, n).reduce((i, o) => i + ai(o & (t === "ascii" ? 127 : 255)), "");
        if (t === "ucs2" || t === "ucs-2" || t === "utf16le" || t === "utf-16le") {
          let i = new DataView(this.buffer.slice(r, n));
          return Array.from({
            length: i.byteLength / 2
          }, (o, s) => s * 2 + 1 < i.byteLength ? ai(i.getUint16(s * 2, !0)) : "").join("");
        }
    ...
    }, gu = new TextEncoder(), yu = new TextDecoder(), hu = ["utf8", "utf-8", "hex", "base64", "ascii", "binary", "base64url", "ucs2", "ucs-2", "utf16le", "utf-16le", "latin1", "latin-1"], wu = 4294967295;
    mu(h.prototype);
    y = new Proxy(bu, {
      construct(e, [t, r]) {
        return h.from(t, r);
...
function jo(e, t) {
  ...
  for (t == null ? (G = !1, a = A) : a = t, s = new v(.03125); e.abs().gte(.1);) e = e.times(s), w += 5;
...
function Qt(e, t) {
  ...
  if (w += R, I.precision = w, r = Ce(D), n = r.charAt(0), o = Z(C), Math.abs(o) < 15e14) {
    for (; n < 7 && n != 1 || n == 1 && r.charAt(1) > 3;) C = C.times(e), r = Ce(C.d), n = r.charAt(0), A++;
    o = Z(C), n > 1 ? (C = new I("0." + r), o++) : C = new I(n + "." + r.slice(1));
  } else return f = li(I, w + 2, M).times(o + ""), C = Qt(new I(n + "." + r.slice(1)), w - R).plus(f), I.precision = M, t == null ? (G = !0, V(C, M)) : C;
  for (a = s = C = Me(C.minus(ge), C.plus(ge), w), v = V(C.times(C), w), i = 3;;) {
    if (s = V(s.times(v), w), f = a.plus(Me(s, new I(i), w)), Ce(f.d).slice(0, w) === Ce(a.d).slice(0, w)) return a = a.times(2), o !== 0 && (a = a.plus(li(I, w + 2, M).times(o + ""))), a = Me(a, new I(A), w), I.precision = M, t == null ? (G = !0, V(a, M)) : a;
    a = f, i += 2;
  }
}
function Vo(e, t) {
...
function V(e, t, r) {
  ...
  if (r !== void 0 && (o = Ke(10, s - i - 1), a = w / o % 10 | 0, f = t < 0 || A[v + 1] !== void 0 || w % o, f = r < 4 ? (a || f) && (r == 0 || r == (e.s < 0 ? 3 : 2)) : a > 5 || a == 5 && (r == 4 || f || r == 6 && (n > 0 ? i > 0 ? w / Ke(10, s - i) : 0 : A[v - 1]) % 10 & 1 || r == (e.s < 0 ? 8 : 7))), t < 1 || !A[0]) return f ? (o = Z(e), A.length = 1, t = t - o - 1, A[0] = Ke(10, (j - t % j) % j), e.e = mt(-t / j) || 0) : (A.length = 1, A[0] = e.e = e.s = 0), e;
  if (n == 0 ? (A.length = v, o = 1, v--) : (A.length = v + 1, o = Ke(10, j - n), A[v] = i > 0 ? (w / Ke(10, s - i) % Ke(10, i) | 0) * o : 0), f) for (;;) if (v == 0) {
    (A[0] += o) == ee && (A[0] = 1, ++e.e);
    break;
  } else {
...
function Ho(e) {
  ...
  function i(o) {
    ...
    if (o.charCodeAt(0) === 45 ? (o = o.slice(1), s.s = -1) : s.s = 1, xu.test(o)) Vo(s, o);else throw Error(ze + o);
  }
...
function Pu(e) {
  ...
  for (t = 0; t < i.length; t += 3) if ((n = e[r = i[t]]) !== void 0) if (mt(n) === n && n >= i[t + 1] && n <= i[t + 2]) this[r] = n;else throw Error(ze + r + ": " + n);
  if ((n = e[r = "LN10"]) !== void 0) if (n == Math.LN10) this[r] = new this(n);else throw Error(ze + r + ": " + n);
  return this;
}
var pt,
  Eu,
  ...
  Go = fe(() => {
    ...
    }, G = !0, he = "[DecimalError] ", ze = he + "Invalid argument: ", ci = he + "Exponent out of range: ", mt = Math.floor, Ke = Math.pow, xu = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, ee = 1e7, j = 7, qo = 9007199254740991, Kr = mt(qo / j), S = {};
    ...
    S.squareRoot = S.sqrt = function () {
      ...
      for (e = Z(a), G = !1, i = Math.sqrt(+a), i == 0 || i == 1 / 0 ? (t = Ce(a.d), (t.length + e) % 2 == 0 && (t += "0"), i = Math.sqrt(t), e = mt((e + 1) / 2) - (e < 0 || e % 2), i == 1 / 0 ? t = "5e" + e : (t = i.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + e), n = new f(t)) : n = new f(i.toString()), r = f.precision, i = s = r + 3;;) if (o = n, n = o.plus(Me(a, o, s + 2)).times(.5), Ce(o.d).slice(0, s) === (t = Ce(n.d)).slice(0, s)) {
    ...
    S.toDecimalPlaces = S.todp = function (e, t) {
      var r = this,
        n = r.constructor;
      return r = new n(r), e === void 0 ? r : (Re(e, 0, pt), t === void 0 ? t = n.rounding : Re(t, 0, 8), V(r, e + Z(r) + 1, t));
    };
    S.toExponential = function (e, t) {
      var r,
        n = this,
        i = n.constructor;
      return e === void 0 ? r = Ye(n, !0) : (Re(e, 0, pt), t === void 0 ? t = i.rounding : Re(t, 0, 8), n = V(new i(n), e + 1, t), r = Ye(n, !0, e + 1)), r;
    };
    S.toFixed = function (e, t) {
      var r,
        ...
        i = this,
        o = i.constructor;
      return e === void 0 ? Ye(i) : (Re(e, 0, pt), t === void 0 ? t = o.rounding : Re(t, 0, 8), n = V(new o(i), e + Z(i) + 1, t), r = Ye(n.abs(), !1, e + Z(n) + 1), i.isneg() && !i.isZero() ? "-" + r : r);
    };
    ...
    S.toPower = S.pow = function (e) {
      ...
      if (t = e.e, r = e.d.length - 1, s = t >= r, o = a.s, s) {
        if ((r = v < 0 ? -v : v) <= qo) {
          for (i = new f(ge), t = Math.ceil(n / j + 4), G = !1; r % 2 && (i = i.times(a), $o(i.d, t)), r = mt(r / 2), r !== 0;) a = a.times(a), $o(a.d, t);
          return G = !0, e.s < 0 ? new f(ge).div(i) : V(i, n);
        }
      } else if (o < 0) throw Error(he + "NaN");
      return o = o < 0 && e.d[Math.max(t, r)] & 1 ? -1 : 1, a.s = 1, G = !1, i = e.times(Qt(a, n + w)), G = !0, i = jo(i), i.s = o, i;
    };
    S.toPrecision = function (e, t) {
      var r,
        ...
        i = this,
        o = i.constructor;
      return e === void 0 ? (r = Z(i), n = Ye(i, r <= o.toExpNeg || r >= o.toExpPos)) : (Re(e, 1, pt), t === void 0 ? t = o.rounding : Re(t, 0, 8), i = V(new o(i), e, t), r = Z(i), n = Ye(i, e <= r || r <= o.toExpNeg, e)), n;
    };
    S.toSignificantDigits = S.tosd = function (e, t) {
      var r = this,
        n = r.constructor;
      return e === void 0 ? (e = n.precision, t = n.rounding) : (Re(e, 1, pt), t === void 0 ? t = n.rounding : Re(t, 0, 8)), V(new n(r), e, t);
    };
    ...
    Me = function () {
      ...
      return function (n, i, o, s) {
        ...
        for (f = n.e - i.e, Ee = z.length, Je = ve.length, C = new Gr(su), D = C.d = [], w = 0; z[w] == (ve[w] || 0);) ++w;
        if (z[w] > (ve[w] || 0) && --f, o == null ? ce = o = Gr.precision : s ? ce = o + (Z(n) - Z(i)) + 1 : ce = o, ce < 0) return new Gr(0);
        if (ce = ce / j + 2 | 0, w = 0, Ee == 1) for (v = 0, z = z[0], ce++; (w < Je || v) && ce--; w++) $ = v * ee + (ve[w] || 0), D[w] = $ / z | 0, v = $ % z | 0;else {
          for (v = ee / (z[0] + 1) | 0, v > 1 && (z = e(z, v), ve = e(ve, v), Ee = z.length, Je = ve.length), ue = Ee, I = ve.slice(0, Ee), M = I.length; M < Ee;) I[M++] = 0;
...
var vi = oe((zx, Ds) => {
  ...
  Ds.exports = function () {
    ...
    return function (t, r) {
      ...
      for (var Je = ue.length - 1; a < o - 3;) for (M = r.charCodeAt(s + (w = a)), be = r.charCodeAt(s + (v = a + 1)), ce = r.charCodeAt(s + (A = a + 2)), $ = r.charCodeAt(s + (R = a + 3)), C = a += 4, f = 0; f < Je; f += 2) D = ue[f], I = ue[f + 1], w = e(D, w, v, M, I), v = e(w, v, A, be, I), A = e(v, A, R, ce, I), C = e(A, R, C, $, I), ue[f] = C, R = A, A = v, v = w, w = D;
      for (; a < o;) for (M = r.charCodeAt(s + (w = a)), C = ++a, f = 0; f < Je; f += 2) D = ue[f], ue[f] = C = e(D, w, C, M, ue[f + 1]), w = D;
      return C;
    };
  }();
});
...
var kl = oe(N => {
  ...
  function id(e = 32) {
    if (Ot.crypto && typeof Ot.crypto.getRandomValues == "function") return Ot.crypto.getRandomValues(new Uint8Array(e));
...
var Fl = oe(H => {
  ...
  for (let e = 0, t = wr, r = 1, n = 0; e < 24; e++) {
    ...
    let i = od;
    for (let o = 0; o < 7; o++) t = (t << wr ^ (t >> ad) * cd) % ld, t & sd && (i ^= wr << (wr << BigInt(o)) - wr);
    Ll.push(i);
  }
...
typeof g < "u" && ({
  ...
  NO_COLOR: Yo,
  TERM: Zo
} = g.env || {}, Xo = g.stdout && g.stdout.isTTY);
var Tu = {
...
function ft(e) {
  let t = Ku();
  return t || (e?.config.engineType === "library" ? "library" : e?.config.engineType === "binary" ? "binary" : e?.config.engineType === "client" ? "client" : zu(e));
}
function Ku() {
...
var xt = class extends Be {
  ...
  writeWithItems(t) {
    ...
    t.writeLine("[").withIndent(() => t.writeJoined(Et, this.items).newLine()).write("]"), this.hasError && t.afterNextNewline(() => {
...
var Pt = class e extends Be {
  ...
  getDeepField(t) {
    ...
    for (let s of n) {
      let a;
      if (o.value instanceof e ? a = o.value.getField(s) : o.value instanceof xt && (a = o.value.getField(Number(s))), !a) return;
      o = a;
    }
    return o;
  }
...
function bp(e, t) {
  let r = e.outputType,
    ...
    i = n?.isEmpty() ?? !1;
  n && (n.removeAllFields(), js(n, r)), t.addErrorMessage(o => i ? `The ${o.red("`select`")} statement for type ${o.bold(r.name)} must not be empty. ${nr(o)}` : `The ${o.red("`select`")} statement for type ${o.bold(r.name)} needs ${o.bold("at least one truthy value")}.`);
}
function Ep(e, t) {
  let r = new tr();
...
function Tp(e, t) {
  ...
  n && (n.getField(r)?.markAsError(), _p(n, e.arguments)), t.addErrorMessage(i => qs(i, r, e.arguments.map(o => o.name)));
}
function vp(e, t) {
...
var gn = Symbol(),
  ...
  Le = class {
    constructor(t) {
      t === gn ? Ci.set(this, `Prisma.${this._getName()}`) : Ci.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
function zs(e, t, r) {
  let n = ke(r);
  return !t.result || !(t.result.$allModels || t.result[n]) ? e : Up({
    ...e,
...
var En = class {
    ...
    clientExtensions = Zt(() => this.extension.client ? {
...
function qp(e, t, r) {
  let n = {};
  return e.modelOrType && !e.isRawAction() && (n.$composites = !0, n.$scalars = !0), t && Bp(n, t, e), jp(n, r, e), n;
}
function Bp(e, t, r) {
...
function ia(e, t) {
  ...
  for (let n in e) {
    let i = e[n],
      o = t.nestArgument(n);
    Oe(i) || (i !== void 0 ? r[n] = na(i, o) : t.isPreviewFeatureOn("strictUndefinedChecks") && t.throwValidationError({
      kind: "InvalidArgumentValue",
...
function In({
  ...
  return t.error_code ? new K(Yp(t, n), {
    code: t.error_code,
    clientVersion: r,
    meta: t.meta,
...
var Ea = e => Array.isArray(e) ? e : e.split("."),
  ...
  xa = (e, t, r) => Ea(t).reduceRight((n, i, o, s) => Object.assign({}, Ni(e, s.slice(0, o)), {
    [i]: n
  }), r);
function im(e, t) {
...
function On({
  ...
  if (Array.isArray(t)) {
    for (let s = 0; s < t.length; s++) t[s] = On({
      result: t[s],
      args: r,
      modelName: i,
      runtimeDataModel: n,
...
function Ra({
  ...
  return n.isEmpty() || e == null || typeof e != "object" || !i.models[t] ? e : On({
    result: e,
    args: r ?? {},
    modelName: t,
    runtimeDataModel: i,
...
function za(e, t, r) {
  ...
  for (let [i, o] of Object.entries(t)) switch (o.type) {
    ...
    case "Value":
      {
        let s = o.dbName;
        if (Object.hasOwn(e, s)) n[i] = ji(e[s], s, o.resultType, r);else throw new W(`Missing data field (Value): '${s}'; node: ${JSON.stringify(o)}; data: ${JSON.stringify(e)}`);
      }
      break;
    default:
...
var tl = 2,
  ...
  rl = Om(),
  _m = rl.length,
  Mm = et(rl.split("").reduce(function (e, t) {
    return +e + t.charCodeAt(0);
  }, +_m + 36).toString(36), tl);
function Gi() {
  return Dm + Mm;
}
c();
...
function Od(e, t, r) {
  let n;
  if (e) n = Xl(e.random ?? e.rng?.() ?? Mt(), e.msecs, e.seq, t, r);else {
    let i = Date.now(),
      o = Mt();
...
function Te(e, t, r) {
  ...
  return Array.isArray(n) ? n = n.map(i => Te(i, t, r)) : tc(n) ? n = y.from(n.prisma__value, "base64") : rc(n) && (n = BigInt(n.prisma__value)), n;
}
function _d(e, t, r) {
  let n = 0,
    i = 1,
...
function ac(e) {
  let r = e.columnTypes.map(n => oc(n)).map(n => {
    switch (n) {
      case "bytes":
...
var Ar = class e {
  ...
  async run(t, r) {
    let {
      value: n
    } = await this.interpretNode(t, r, this.#t, this.#n.snapshot(r.provider)).catch(i => Xa(i));
    return n;
  }
      ...
      case "validate":
        {
          ...
          return lc(o, t.args.rules, t.args), {
            value: o,
            lastInsertId: s
          };
        }
  ...
  Sr = class {
    ...
    getActiveTransaction(t, r) {
      ...
      if (!n) {
        ...
        if (i) switch (Rr("Transaction already closed.", {
          transactionId: t,
          status: i.status
        }), i.status) {
          case "waiting":
    ...
    startTransactionTimeout(t, r) {
      ...
      return setTimeout(async () => {
        ...
        i && ["running", "waiting"].includes(i.status) ? await this.closeTransaction(i, "timed_out") : Rr("Transaction already committed or rolled back when timeout happened.", t);
      }, r);
    }
    async closeTransaction(t, r) {
      Rr("Closing transaction.", {
        transactionId: t.id,
        status: r
      }), t.status = r;
      try {
        if (t.transaction && r === "committed") {
          if (t.transaction.options.usePhantomQuery) await this.#n(Hd(), t.transaction, () => t.transaction.commit());else {
            let n = jd();
...
var Jn = class e {
  ...
  static async connect(t) {
    let r, n;
    try {
      r = await t.driverAdapterFactory.connect(), n = new Sr({
        driverAdapter: r,
  ...
  getConnectionInfo() {
    let t = this.#t.getConnectionInfo?.() ?? {
...
function Nt({
  ...
  let i,
    ...
    s = e[o]?.url,
    a = t[o]?.url;
  if (o === void 0 ? i = void 0 : a ? i = a : s?.value ? i = s.value : s?.fromEnvVar && (i = r[s.fromEnvVar]), s?.fromEnvVar !== void 0 && i === void 0) throw kt().id === "workerd" ? new U(`error: Environment variable not found: ${s.fromEnvVar}.
...
function Yn(e) {
  ...
  if (o !== "prisma:" && o !== on) throw new ot(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\` or \`prisma+postgres://\``, t);
  let a = s.get("api_key");
  if (a === null || a.length < 1) throw new ot(`Error validating datasource \`${r}\`: the URL must contain a valid API key`, t);
...
var yc = J("prisma:client:clientEngine:remoteExecutor"),
  ...
  xo = class {
    ...
    async request({
      ...
      return yc(t, s, f.status, f.statusText), this.#r = f.headers.get("Accelerate-Query-Engine-Jwt") ?? void 0, this.#o(s, f), f;
    }
    #n(t) {
      let r = [],
        n = new Date();
...
var kr = class {
  ...
  #o;
  constructor(t, r, n) {
    if (!t.previewFeatures?.includes("driverAdapters") && !r) throw new U("EngineType `client` requires the driverAdapters preview feature to be enabled.", t.clientVersion, wc);
    if (r) this.#n = {
      remote: !0
    };else if (t.adapter) this.#n = {
      remote: !1,
      driverAdapterFactory: t.adapter
    }, Ir("Using driver adapter: %O", t.adapter);else throw new U("Missing configured driver adapter. Engine type `client` requires an active driver adapter. Please check your PrismaClient initialization code.", t.clientVersion, wc);
    this.#r = n ?? hc, this.config = t, this.logQueries = t.logQueries ?? !1, this.logLevel = t.logLevel ?? "error", this.logEmitter = t.logEmitter, this.datamodel = t.inlineSchema, this.tracingHelper = t.tracingHelper, t.enableDebugLogs && (this.logLevel = "debug"), this.logQueries && (this.#o = i => {
  ...
  #c(t, r) {
    ...
    if (t.code === "GenericFailure" && t.message?.startsWith("PANIC:")) return new ae(bc(this, t.message, r), this.config.clientVersion);
    if (t instanceof De) return new K(t.message, {
      code: t.code,
      meta: t.meta,
      clientVersion: this.config.clientVersion
    });
...
${n.backtrace}`, {
  ...
  #u(t) {
    return t instanceof ae ? t : typeof t.message == "string" && typeof t.code == "string" ? new K(t.message, {
      code: t.code,
      meta: t.meta,
      clientVersion: this.config.clientVersion
    }) : t;
  ...
  async requestBatch(t, {
    ...
    try {
      ...
      switch (f.type) {
        case "multi":
          {
            A = await Promise.all(f.plans.map((R, C) => s.execute({
              plan: R,
              placeholderValues: v,
              model: t[C].modelName,
  ...
  #d(t, r, n) {
    ...
    return r.arguments.map(s => {
      ...
      if (a === -1) return r.expectNonEmpty ? new K("An operation failed because it depends on one or more records that were required but not found", {
        code: "P2025",
        clientVersion: this.config.clientVersion
      }) : {
        data: {
...
async function qr(e, t) {
  ...
  let r = {
    ...
    n = await Xd(e);
  if (n.type === "QueryEngineError") throw new K(n.body.message, {
  ...
  Qr = class {
    ...
    async start() {
      this.startPromise !== void 0 && (await this.startPromise), this.startPromise = (async () => {
        ...
        this.host = r.host, this.protocol = r.protocol, this.headerBuilder = new Ut({
          apiKey: t,
          tracingHelper: this.tracingHelper,
          logLevel: this.config.logLevel ?? "error",
          logQueries: this.config.logQueries,
          engineHash: this.engineHash
        }), this.remoteClientVersion = await Cc(this.host, this.config), jr("host", this.host), jr("protocol", this.protocol);
    ...
    async handleError(t) {
      if (t instanceof at) throw await this.uploadSchema(), new Vt({
        clientVersion: this.clientVersion,
        cause: t
      });
      if (t) throw t;
    ...
    convertProtocolErrorsToClientError(t) {
      return t.length === 1 ? In(t[0], this.config.clientVersion, this.config.activeProvider) : new se(JSON.stringify(t), {
        clientVersion: this.config.clientVersion
      });
    }
    applyPendingMigrations() {
...
var sf = /^(\s*alter\s)/i,
  Nc = J("prisma:client");
function Io(e, t, r, n) {
  if (!(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && sf.exec(t)) throw new Error(`Running ALTER using ${n} is not supported
...
function jc(e) {
  ...
  let t = [];
  return e.modelName && t.push(e.modelName), e.query.arguments && t.push(_o(e.query.arguments)), t.push(_o(e.query.selection)), t.join("");
}
function _o(e) {
  ...
  ii = class {
    ...
    handleRequestError({
      ...
      if (n && (f = cn({
        ...
        if (t instanceof se) throw new se(f, {
          clientVersion: this.client._clientVersion,
          batchRequestIdx: t.batchRequestIdx
        });
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (e, t) => {
      if (!e && ft(t.generator) === "client") throw new F('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.');
      if (e === null) return;
      if (e === void 0) throw new F('"adapter" property must not be undefined, use null to conditionally disable driver adapters.');
      if (!Xn(t).includes("driverAdapters")) throw new F('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.');
      if (ft(t.generator) === "binary") throw new F('Cannot use a driver adapter with the "binary" Query Engine. Please use the "library" Query Engine.');
    },
    datasourceUrl: e => {
  ...
  class t {
    ...
    constructor(n) {
      ...
      if (n?.adapter) {
        ...
        if (s.provider !== f) throw new U(`The Driver Adapter \`${s.adapterName}\`, based on \`${s.provider}\`, is not compatible with the provider \`${f}\` specified in the Prisma schema.`, this._clientVersion);
        if (n.datasources || n.datasourceUrl !== void 0) throw new U("Custom datasource configuration is not compatible with Prisma Driver Adapters. Please define the database connection string directly in the Driver Adapter configuration.", this._clientVersion);
      }
