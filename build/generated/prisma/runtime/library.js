...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
  ...
  function ks(e) {
    ...
    if (e && e.path && e.path.length > 0) {
      if (Array.isArray(e.path)) for (let t of e.path) Li.existsSync(t) && (r = t.endsWith(".vault") ? t : `${t}.vault`);else r = e.path.endsWith(".vault") ? e.path : `${e.path}.vault`;
...
function y(e, r, t, n) {
  ...
  e: if (r != null) {
    ...
    if (o = r - i, o < 0) o += E, s = r, c = p[d = 0], l = c / U(10, i - s - 1) % 10 | 0;else if (d = Math.ceil((o + 1) / E), a = p.length, d >= a) {
      if (n) {
        for (; a++ <= d;) p.push(0);
...
function Je(e, r) {
  ...
  for (p = g, l = s = g = L(g.minus(1), g.plus(1), c, 1), d = y(g.times(g), c, 1), i = 3;;) {
    if (s = y(s.times(d), c, 1), u = l.plus(L(s, new P(i), c, 1)), J(u.d).slice(0, c) === J(l.d).slice(0, c)) if (l = l.times(2), o !== 0 && (l = l.plus(fn(P, c + 2, b).times(o + ""))), l = L(l, new P(f), c, 1), r == null) {
      if (at(l.d, c - h, R, a)) P.precision = c += h, u = s = g = L(p.minus(1), p.plus(1), c, 1), d = y(g.times(g), c, 1), i = a = 1;else return y(l, P.precision = b, R, w = !0);
...
function jp(e) {
  ...
  if (t = "crypto", i && (this[t] = Bi[t]), (n = e[t]) !== void 0) if (n === !0 || n === !1 || n === 0 || n === 1) {
    if (n) {
...
var Wa = e => Array.isArray(e) ? e : e.split("."),
  ...
  Ja = (e, r, t) => Wa(r).reduceRight((n, i, o, s) => Object.assign({}, so(e, s.slice(0, o)), {
    [i]: n
  }), t);
function Om(e, r) {
